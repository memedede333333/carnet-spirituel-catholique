...
export default function RelecturePage() {
  ...
  if (loading) {
    return (
      <div style={{
        minHeight: '100vh',
        background: 'linear-gradient(to bottom right, #FFFFFF 0%, #F8FAFF 33%, #F0F4FF 66%, #E6EDFF 100%)',
        padding: '2rem 1rem',
        display: 'flex',
        alignItems: 'center',
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '0.5rem',
              border: 'none',
              background: viewMode === 'fleuve' ? '#7BA7E1' : 'transparent',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '0.5rem',
              border: 'none',
              background: viewMode === 'constellation' ? '#7BA7E1' : 'transparent',
